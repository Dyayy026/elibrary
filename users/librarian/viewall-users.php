            ...
            <div class="container" id="brw-table">
                ...
                <div class="span9">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "SELECT * FROM u_details INNER JOIN u_type
                        ON u_details.ut_id = u_type.ut_id WHERE date_added is NOT NULL ORDER BY l_name ASC LIMIT $start_from, $limit";
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="delete_user.php?id1=<?php echo $sch_id ?>" class="btn btn-danger">Delete</a></a>
