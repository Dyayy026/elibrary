                ...
                <div class="login-wrap">
                    ...
                    <form action="#" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="School ID No." name="pword1" required="">
                        </div>

                        <div class="form-group">
                            <label class="label" for="password">Confirm Password</label>
                            <input type="password" class="form-control" placeholder="Password" name="pword2" required="">
                        </div>
                        <p class=""><a href="AAforgot_pass.php">Back to forgot password?</a> </p>

                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-dark submit button two" name="reset_password"><span>Submit</span> </button>
                        </div>
                    </form>
...
<?php
    if(isset($_POST["reset_password"])){
		...
		if($psw == $psw2){
			...
			$sql = mysqli_query($conn, "SELECT * FROM u_details WHERE email='$email' AND date_added IS NOT NULL");
